...
values ('Michael', 'Smith', to_date('2001-06-22', 'YYYY-MM-DD'),
...
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Robert', 'Tyler', to_date('2000-02-09', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Administration'),
  'Treasurer',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Susan', 'Hawthorne', to_date('2002-04-24', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Operations Manager',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('John', 'Gooding', to_date('2003-11-14', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Loans'),
  'Loan Manager',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Helen', 'Fleming', to_date('2004-03-17', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Chris', 'Tucker', to_date('2004-09-15', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Sarah', 'Parker', to_date('2002-12-02', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Jane', 'Grossman', to_date('2002-05-03', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Headquarters'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Paula', 'Roberts', to_date('2002-07-27', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'Woburn Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Thomas', 'Ziegler', to_date('2000-10-23', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Woburn Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Samantha', 'Jameson', to_date('2003-01-08', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Woburn Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('John', 'Blake', to_date('2000-05-11', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'Quincy Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Cindy', 'Mason', to_date('2002-08-09', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Quincy Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Frank', 'Portman', to_date('2003-04-01', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'Quincy Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Theresa', 'Markham', to_date('2001-03-15', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Head Teller',
  (select branch_id from branch where name = 'So. NH Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Beth', 'Fowler', to_date('2002-06-29', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'So. NH Branch'));
insert into employee (fname, lname, start_date,
  dept_id, title, assigned_branch_id)
values ('Rick', 'Tulman', to_date('2002-12-12', 'YYYY-MM-DD'),
  (select dept_id from department where name = 'Operations'),
  'Teller',
  (select branch_id from branch where name = 'So. NH Branch'));
...
insert into officer (cust_id, fname, lname,
  title, start_date)
select cust_id, 'Paul', 'Hardy', 'President', to_date('2001-01-01', 'YYYY-MM-DD')
from customer
where fed_id = '04-2222222';
insert into customer (fed_id, cust_type_cd,
  address, city, state, postal_code)
...
insert into officer (cust_id, fname, lname,
  title, start_date)
select cust_id, 'Carl', 'Lutz', 'President', to_date('2002-06-30', 'YYYY-MM-DD')
from customer
where fed_id = '04-3333333';
insert into customer (fed_id, cust_type_cd,
  address, city, state, postal_code)
